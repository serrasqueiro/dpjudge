...
class PostScriptMap:
		...
		for line in lines:
			...
			if section in 'MS': 
				...
				if msg:
					...
					retractions[di['nick']] = len(self.retreats)
	...
	#	----------------------------------------------------------------------
	def removeUnit(self, power, where):
